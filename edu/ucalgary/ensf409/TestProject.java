...
>>>>>>> Stashed changes
     ...
     */
    @Test
    public void testAddClientToHamperGoodData(){
        Hamper testHamper = new Hamper();
        testHamper.addClient(3);
        testHamper.addClient(4);
        ArrayList<Client> found = testHamper.getClient();
        ClientType[] expectedList = {ClientType.CHILDOVER8,ClientType.CHILDUNDER8};
...
//        Initalizing another FoodBank object since it will have the newly updated database
     ...
     */
    @Test
    public void testHamperGetClient(){
        Hamper testHamper = new Hamper();
